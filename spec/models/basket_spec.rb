RSpec.describe Basket, type: :model do
    ...
    describe '.refresh' do
        ...
        let!(:line_ingrid_1) { create :line_ingrid, recipe: recipe_1, ingridient: ingridients.first, measure: measure_1, quantity: 200 }
